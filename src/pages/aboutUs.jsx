...
function AboutUs() {
  ...
  return (
    <div style={{ textAlign: "center", padding: "20px" }}>
      ...
      <div style={{ display: "flex", justifyContent: "center", gap: "20px", marginTop: "20px" }}>
        {teamMembers.map((member, index) => (
          <div key={index} style={{ textAlign: "center" }}>
            <img src={member.avatar} alt={member.name} style={{ borderRadius: "50%", width: "150px", height: "150px" }} />
            <h3>{member.name}</h3>
      ...
      <div style={{ marginTop: "40px", padding: "20px", maxWidth: "800px", margin: "auto" }}>
        <h3>About Partigiano</h3>
        <p>
          Partigiano is a blogging platform that champions freedom of speech and expression.
          With various categories covering diverse topics, we provide a space for writers
          to share their thoughts, experiences, and opinions openly. Our mission is to
          create a community where ideas flourish without limitations.
        </p>
      </div>
    </div>
  );
